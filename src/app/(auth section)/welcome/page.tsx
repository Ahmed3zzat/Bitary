...
export default function Home() {
  return (
    <div className="relative h-[calc(100vh-4.5rem)] bg-[url('.././assets/images/SplashScreen.jpg')] bg-cover bg-no-repeat bg-center flex flex-col items-center justify-center">
